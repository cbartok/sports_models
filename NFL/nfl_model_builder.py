...
def import_nfl_model(folder_path=None, file_name='nfl_model.pickle'):
        '''
        Load a saved nfl model
        '''
        if folder_path is None:
            with open(file_name, 'rb') as model_file:
                nfl_model = pickle.load(model_file)
        else:
...
class NFLModel():
    ...
    def save_nfl_model(self, model, folder_path=None, file_name='nfl_model.pickle'):
        '''
